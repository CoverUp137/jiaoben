...
# 安装python
echo -e "${YELLOW}😂是否要安装Python？😂${NC}"
echo -e "1. 安装Python和wget"
echo -e "2. 跳过安装"
...
if [ "$install_option" -eq 1 ]; then
  ...
  echo -e "${GREEN}✅已安装Python和wget${NC}"
else
  echo -e "${YELLOW}❗已跳过安装Python和wget❗${NC}"
fi
...
echo -e "${YELLOW}😂是否要下载MIUI签到脚本？😂${NC}"
echo -e "1. 下载脚本"
echo -e "2. 跳过下载脚本"
...
# 安装python依赖
echo -e "${YELLOW}😂是否要安装Python依赖？😂${NC}"
echo -e "1. 安装Python依赖"
echo -e "2. 跳过安装Python依赖"
...
if [ "$install_dep_option" -eq 1 ]; then
  ...
  echo -e "${YELLOW}❗已跳过安装Python依赖❗${NC}"
fi
